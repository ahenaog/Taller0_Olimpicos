...
public class CalculadoraEstadisticas
{
	...
	/**
	 * Retorna el pais al que pertenece un atleta
	 * 
	 * @return Un string que representa el país al que pertenece un atleta.
	 */
	public String paisPorAtleta(String nombreAtleta)
	{
		...
		if (elatleta != null)
		{
			resultadoPais = elatleta.darPais();
			nombrePais = resultadoPais.darNombre();
		}
