...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el país al que pertence un atleta");
		System.out.println("14. Salir de la aplicación\n");
	}
	
	/**
	 * Le muestra al usuario el país al que pertenece un atleta.
	 */
	private void ejecutarPaisPorAtleta()
	{
		...
		String elpais = calculadora.paisPorAtleta(nombreAtleta);
		
		if (elpais != null)
		{
			System.out.println("El país al que pertenece el/la atleta " + nombreAtleta + " es: " + elpais );
		}
		else
		{
			System.out.println("No se encontró el atleta que se ingresó");
		}
